...
public class App extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// 1 Calcolare le dimensioni dello schermo una volta sola
		SceneManager.initializeScreenSize();

		// 2 Registrare lo stage nel SceneManager
		SceneManager.setPrimaryStage(primaryStage);

		// 3 Caricare la login già con dimensioni schermo
		...
		// 4 Applicazione finestra fullscreen senza flash
