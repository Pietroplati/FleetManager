...
/**
 * Interfaccia di servizio per la gestione delle {@link Prenotazione} nel sistema
 * FleetManager.
 * <p>
 ...
 * della logica applicativa e delegano la persistenza allo strato repository/DAO.
 * </p>
 */
public interface GestorePrenotazioni {
     ...
     * @return {@code true} se il veicolo risulta disponibile nell'intervallo richiesto; {@code false} altrimenti
     */
     ...
     * @return lista delle prenotazioni del veicolo (eventualmente vuota, mai {@code null})
     */
     ...
     * <p>
     * L'operazione comporta l'aggiornamento dello stato della prenotazione
     ...
     * <p>
     * Tipicamente utilizzato per sincronizzare lo stato delle prenotazioni con il passare del tempo
     * (ad esempio prenotazioni che diventano attive o completate).
     * </p>
     */
     ...
     * </p>
     *
     * @return lista completa delle prenotazioni (eventualmente vuota, mai {@code null})
     */
    List<Prenotazione> getTuttePrenotazioni();

    /**
     * Restituisce le prenotazioni visibili all'utente loggato:
     * tutte se l'utente è un manager, solo le proprie se l'utente è un driver.
     * Le prenotazioni sono restituite già ordinate secondo le regole applicative.
     *
