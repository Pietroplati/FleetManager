...
/**
 * Tool di bootstrap/debug: stampa i contenuti delle tabelle. NON dipende più da
 * it.fleetmanager.repository.* (riduce Tangled) Logica invariata: legge tutte
 * le tabelle e stampa le righe.
 */
