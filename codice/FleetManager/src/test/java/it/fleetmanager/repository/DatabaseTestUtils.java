...
public class DatabaseTestUtils {
    ...
    private static final String TEST_URL =
            "jdbc:h2:mem:fleetdb;DB_CLOSE_DELAY=-1;MODE=PostgreSQL";

    /**
     * Imposta il DB H2 in memoria per i test
     */
    ...
    /**
     * Reset completo del DB di test:
     * - drop schema
     * - recreate schema (identico al reale)
     * - seed MINIMO necessario ai test
     */
    public static void resetDatabase() throws SQLException {
        ...
        try (Connection conn = H2DatabaseManager.getInstance().getConnection();
            ...
            stmt.execute("""
                ...
                CREATE TYPE tipo_prenotazione AS ENUM ('UTENTE','MANUTENZIONE');
            ...
            stmt.execute("""
                INSERT INTO Utente (nome, cognome, email, password, ruoloUtente, patente)
                VALUES
                ('Mario','Rossi','manager@test.it','pwd','MANAGER',NULL),
                ('Luca','Bianchi','driver@test.it','pwd','DRIVER','AB123456');
            """);
        }
    }
}
